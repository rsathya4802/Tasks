...
'''
    Resize images to 28 X 28 because model was trained using 28 X 28 MNIST Images
...
load_chkpoint(torch.load('./part_2_standard_mnist/part_2_standard_mnist_pretrained.pth.tar',map_location=device),model)
