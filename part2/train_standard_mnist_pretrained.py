'''
    Training using Pretrained model that was trained on the dataset created
    by extracting 0-9 images from the dataset used for Part 1
'''
...
'''
    Standard MNIST is used to train
...
def test_model():
    ...
    load_chkpoint(torch.load('./part_2_standard_mnist_pretrained.pth.tar',map_location=device),model)
